...
class profile::pr_dynatrace1agent {
  ...
  if $facts['kernel'] == 'Linux' {
    ...
    class { 'dynatraceoneagent':
        ...
        download_link => 'https://jty656.dynatrace-managed.com/e/56f21ab8-4f4b-4a14-9afb-bd493a8884ac/api/v1/deployment/installer/agent/unix/default/latest?Api-Token=ykJK2lC6S8eWmZwETfVYn&arch=x86&flavor=default',
        download_dir  => '/tmp',
        user          => 'dynatrace',
