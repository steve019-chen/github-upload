...
sudo::conf { 'puppet_nginx':
  ...
  content  => 'infra ALL=NOPASSWD : /opt/puppetlabs/bin/puppet agent -t, /sbin/service nginx *, /bin/vi /etc/nginx/conf.d *, /bin/vi /etc/nginx/nginx.conf, /sbin/iptables *, vi /etc/nginx/html/srv/policies/Saml1.1-SenderVouches.xml',
