...
sudo::conf { 'puppet_nginx':
  priority => 10,
  content  => 'infra ALL=NOPASSWD : /usr/sbin/nginx *, /opt/puppetlabs/bin/puppet agent -t, /sbin/service nginx *, /bin/vi /etc/nginx/conf.d *, /bin/vi /etc/nginx/nginx.conf, /sbin/iptables *, /bin/vi /etc/nginx/html/srv/policies/Saml1.1-SenderVouches.xml',  }
